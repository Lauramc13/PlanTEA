package com.example.plantea.presentacion.receivers
...
class OnAlarmReceiver : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            Log.e("Receiver", "ON RECEIVE EJECUTADO")
            if(intent.extras!!.getBoolean("CambiarVisibilidad")){
                ...
                Log.i("CalendarioViewModel", "Recibiendo alarma para el evento: ${intent.extras!!.getString("Evento")}")
