...
class AdaptadorCalendarioMensualFechas(var fechas: ArrayList<DiaMes>, private val listener: OnItemSelectedListener?, private val isPDF:Boolean) : RecyclerView.Adapter<AdaptadorCalendarioMensualFechas.ViewHolderCalendarioMensual>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderCalendarioMensual, position: Int) {
        ...
        holder.titulo.text = fechas[position].nombre

        if(isPDF){
            holder.fecha.textSize = 17f
            holder.titulo.textSize = 20f
        }
