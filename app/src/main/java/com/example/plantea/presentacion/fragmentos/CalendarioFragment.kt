...
class CalendarioFragment : DialogFragment(){
    ...
    private fun observer(){
        if(isAdded && isResumed){
            ...
            viewModel.mdDias.observe(viewLifecycleOwner) {
                ...
                val listaDays =
                    if (CommonUtils.isMobile(requireActivity()) && Locale.getDefault().language == "es") {
                ...
                viewModel.eventos =
                    viewModel.evento.obtenerTodosEventos(viewModel.idUsuario, context as Activity)
...
//            viewModel._fechaSeleccionada.observe(viewLifecycleOwner) {
//                // Si se selecciona un día, se filtra los eventos por el dia seleccionado
//            }
        }
