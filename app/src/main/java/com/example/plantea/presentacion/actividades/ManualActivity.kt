...
class ManualActivity : AppCompatActivity() {
    lateinit var parrafo1: TextView
    lateinit var parrafo2: TextView
    lateinit var parrafo3: TextView
    lateinit var parrafo4: TextView
    lateinit var parrafo5: TextView
    lateinit var parrafo6: TextView
    lateinit var parrafo7: TextView
    lateinit var parrafo8: TextView
    lateinit var parrafo9: TextView
    lateinit var parrafo10: TextView
    lateinit var parrafo11: TextView
    lateinit var parrafo12: TextView
    lateinit var parrafo13: TextView
    lateinit var parrafo14: TextView
    lateinit var parrafo15: TextView
    lateinit var parrafo16: TextView
    lateinit var parrafo17: TextView
    lateinit var parrafo18: TextView
    lateinit var parrafo19: TextView
    lateinit var parrafo20: TextView
    lateinit var parrafo21: TextView
    lateinit var parrafo22: TextView
    lateinit var parrafo23: TextView
    lateinit var parrafo24: TextView
    lateinit var parrafo25: TextView
    lateinit var parrafo26: TextView
    lateinit var parrafo27: TextView
    lateinit var parrafo28: TextView
    lateinit var parrafo29: TextView
    lateinit var parrafo30: TextView
    lateinit var parrafo31: TextView
    lateinit var parrafo32: TextView
    lateinit var parrafo33: TextView
    lateinit var parrafo34: TextView
    lateinit var parrafo35: TextView
    lateinit var parrafo36: TextView
    lateinit var parrafo37: TextView
    lateinit var parrafo38: TextView
    lateinit var parrafo39: TextView
    lateinit var parrafo40: TextView
    lateinit var parrafo41: TextView
    lateinit var parrafo42: TextView
    lateinit var parrafo43: TextView
    lateinit var vista: ScrollView
    lateinit var indice: View
    lateinit var btn_subir: FloatingActionButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*Objeto tranquilizador*/parrafo5.setText(HtmlCompat.fromHtml("<br><b>-Objeto Tranquilizador: </b>También se podrá seleccionar una imagen y nombre que represente el objeto que calme a la persona para el caso de que la planificación no salga bien.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))

        /*Notificaciones*/parrafo6.setText(HtmlCompat.fromHtml("<br><b>-Notificaciones: </b>Se podrá activar o desactivar la notificación de las citas médicas planificadas y seleccionar la antelación para recibir el aviso.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))
        ...
        /*4.2 Uso seguro de la aplicación: Autenticación*/parrafo11.setText(HtmlCompat.fromHtml("<br><h2>4.2 Uso seguro de la aplicación: Autenticación</h2> Para acceder a las funcionalidades correspondientes al usuario planificador se solicitará la contraseña creada.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))

        /*4.3 Cambio de contraseña*/parrafo12.setText(HtmlCompat.fromHtml("<br><h2>4.3 Cambio de contraseña</h2> Para realizar el cambio de contraseña, se solicitará la contraseña actual, la nueva contraseña, la cual se deberá introducir dos veces, para su verificación. Al tocar el botón “Guardar”, la contraseña será actualizada.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))
        ...
        /*4.5 Creación de un evento/cita médica*/parrafo16.setText(HtmlCompat.fromHtml("<br><h2>4.5 Creación de un evento/cita médica</h2>" +
        ...
        /*Opciones de los eventos/citas médicas*/parrafo21.setText(HtmlCompat.fromHtml("<br><h2>Opciones de los eventos/citas médicas</h2>" +
        ...
        /*4.6 Creación de una planificación*/parrafo22.setText(HtmlCompat.fromHtml("<br><h2>4.6 Creación de una planificación</h2>En esta pantalla se encuentran siete categorías (Consultas, Profesionales, Lugares, Desplazamiento, Acción, Entretenimiento y Recompensa) que agrupan los pictogramas disponibles para crear una planificación.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))

        /*Pictogramas*/parrafo23.setText(HtmlCompat.fromHtml("<br><h2>Pictogramas</h2>Al seleccionar una de estas categorías, se mostrará la lista de pictogramas relacionados. Para volver atrás o salir de una categoría se tocará el icono     .<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))
        ...
        /*Creación de un nuevo pictograma*/parrafo26.setText(HtmlCompat.fromHtml("<br><h2>Creación de un nuevo pictograma</h2>En cada categoría se puede añadir nuevos pictogramas. Para ello se tocará el icono  . Se mostrará una ventana para la creación del nuevo pictograma. " +
        ...
        /*Pasos para crear planificación*/parrafo28.setText(HtmlCompat.fromHtml("<br><h2>Pasos para crear planificación</h2>A la hora de crear una planificación será necesario seguir los siguientes pasos: <br><br>" +
        ...
        /*Opciones de las planificaciones*/parrafo30.setText(HtmlCompat.fromHtml("<br><h2>Opciones de las planificaciones</h2>En las planificaciones guardadas se pueden encontrar tres opciones:<br>" +
        ...
        /*5.2 Seguimiento de una planificación*/parrafo33.setText(HtmlCompat.fromHtml("<br><h2>5.2 Seguimiento de una planificación</h2> Si hay una planificación visible, se mostrará para poder seguirla.<br>", HtmlCompat.FROM_HTML_MODE_LEGACY))
        ...
        /*5.3 Cuaderno de comunicación*/parrafo37.setText(HtmlCompat.fromHtml("<br><h2>5.3 Cuaderno de comunicación</h2>" +
        ...
        /*Categorías del cuaderno de comunicación*/parrafo40.setText(HtmlCompat.fromHtml("<h2>Categorías del cuaderno de comunicación</h2>" +
        ...
        /*Botón para subir al indice*/btn_subir.setOnClickListener(View.OnClickListener { vista.scrollTo(0, indice.getTop()) })
    }

    fun mostrarIcono(icono: Int, texto: CharSequence?, start: Int, end: Int, tintarIcono: Boolean): SpannableString {
    ...
    fun onclick_punto_1(v: View?) {
        vista!!.scrollTo(0, parrafo1!!.top)
    }

    fun onclick_punto_2(v: View?) {
        vista!!.scrollTo(0, parrafo2!!.top)
    }

    fun onclick_punto_2_1(v: View?) {
        vista!!.scrollTo(0, parrafo3!!.top)
    }

    fun onclick_punto_2_2(v: View?) {
        vista!!.scrollTo(0, parrafo5!!.top)
    }

    fun onclick_punto_2_3(v: View?) {
        vista!!.scrollTo(0, parrafo6!!.top)
    }

    fun onclick_punto_3(v: View?) {
        vista!!.scrollTo(0, parrafo8!!.top)
    }

    fun onclick_punto_4(v: View?) {
        vista!!.scrollTo(0, parrafo10!!.top)
    }

    fun onclick_punto_4_1(v: View?) {
        vista!!.scrollTo(0, parrafo10!!.top)
    }

    fun onclick_punto_4_2(v: View?) {
        vista!!.scrollTo(0, parrafo11!!.top)
    }

    fun onclick_punto_4_3(v: View?) {
        vista!!.scrollTo(0, parrafo12!!.top)
    }

    fun onclick_punto_4_4(v: View?) {
        vista!!.scrollTo(0, parrafo13!!.top)
    }

    fun onclick_punto_4_5(v: View?) {
        vista!!.scrollTo(0, parrafo16!!.top)
    }

    fun onclick_punto_4_6(v: View?) {
        vista!!.scrollTo(0, parrafo21!!.top)
    }

    fun onclick_punto_4_7(v: View?) {
        vista!!.scrollTo(0, parrafo22!!.top)
    }

    fun onclick_punto_4_8(v: View?) {
        vista!!.scrollTo(0, parrafo23!!.top)
    }

    fun onclick_punto_4_9(v: View?) {
        vista!!.scrollTo(0, parrafo26!!.top)
    }

    fun onclick_punto_4_10(v: View?) {
        vista!!.scrollTo(0, parrafo28!!.top)
    }

    fun onclick_punto_4_11(v: View?) {
        vista!!.scrollTo(0, parrafo30!!.top)
    }

    fun onclick_punto_5(v: View?) {
        vista!!.scrollTo(0, parrafo31!!.top)
    }

    fun onclick_punto_5_1(v: View?) {
        vista!!.scrollTo(0, parrafo31!!.top)
    }

    fun onclick_punto_5_2(v: View?) {
        vista!!.scrollTo(0, parrafo33!!.top)
    }

    fun onclick_punto_5_3(v: View?) {
        vista!!.scrollTo(0, parrafo37!!.top)
    }

    fun onclick_punto_5_4(v: View?) {
